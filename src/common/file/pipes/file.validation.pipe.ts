...
import type { IValidationErrorImport } from "src/common/error/interfaces/error.interface";
...
import type { IFileExtract } from "src/common/file/interfaces/file.interface";
